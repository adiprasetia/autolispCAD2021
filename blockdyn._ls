...
;; =========================================================================
;; 2. CONTOH CARA PENGGUNAANNYA UNTUK BLOCK "FREESTALL DOUBLE"
;; =========================================================================
(defun c:freestalldouble ( / ptAwal panjang)
  ...
  (if ptAwal
    (progn
      (setq panjang (getreal "\nMasukkan jumlah freestall (satu baris) ")*1200+1200)
      
      (if panjang
        (progn
          ;; Langkah 1: Insert Blocknya terlebih dahulu (Skala 1, Sudut 0)
          (command "._-INSERT" "freestall double dyn - 5400mm" "_non" ptAwal 1 1 0)
